<template>
  <v-container class="text-center">
    <v-row class="my-12">
      <v-col>
        <h1 class="display-1 primary--text my-8">What is A2SV</h1>
        <p class="body-1">
          A2SV is a 3 months interview preparation program that focuses on
          algorithms, data structures, problem solving, communication skills,
          and personal development.
        </p>
        <p class="body-1">
          For more information, please watch the <a href="">trailer</a>, take a
          look at the <a href="">progress sheet</a>, and check out the
          <a href="">lecture videos</a>.
        </p>
      </v-col>
    </v-row>
    <br />
    <v-row v-for="(item, i) in lists" :key="i" class="my-12 px-12 mx-12">
      <v-col class="my-12">
        <h1 class="display-1 primary--text">{{ item.title }}</h1>
        <v-subheader class="justify-center">{{ item.subtitle }}</v-subheader>

        <v-row>
          <v-col
            v-for="(act, j) in item.list"
            :key="i + '-' + j"
            cols="4"
            class="px-10"
          >
    ...
    return {
      lists: [
        ...
        },
        {
          ...
          subtitle: "On the top of what we do in the first part, we have a month long camp, 6 days a week.",
          list: [
            {
            ...
            },
            {
              ...
              content:
                'Games and social activities for team building',
            },
          ],
        },
      ],
