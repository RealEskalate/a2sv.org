<template v-slot:activator="{ on, attrs }">
  <div class="blue-bg" :class="{'banner-sm': $vuetify.breakpoint.smAndDown, 'banner-lg': $vuetify.breakpoint.mdAndUp}">
    <v-container>
      <v-row>
...
export default {
  ...
  props: { "title": String, "description": String, "img": String, "imgWidth": String },
  mounted() {
